    ...
    <div class="container">
        <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
          ...
          <div class="nav-collapse">
			<?php 
			$vdbs = Vdb::model()->findAllByAttributes(array('user_id'=>Yii::app()->user->id,));
			$this->widget('zii.widgets.CMenu',array(
                    ...
                    'encodeLabel'=>false,
                    'items'=>array(
                        array('label'=>'My VDBs  <span class="badge badge-warning pull-right">'.count($vdbs).'</span>', 'url'=>array('/vdb/index')),
